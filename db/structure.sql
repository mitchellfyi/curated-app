...
CREATE TABLE public.tags (
    ...
    published_at timestamp(6) without time zone,
    visibility integer DEFAULT 0 NOT NULL,
    tag_list_count integer DEFAULT 0 NOT NULL,
...
--
-- Name: index_items_on_source_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_items_on_source_id ON public.items USING btree (source_id);
...
--
-- Name: index_taggings_on_creator; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_taggings_on_creator ON public.taggings USING btree (creator_type, creator_id);


--
-- Name: index_taggings_on_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_taggings_on_role_id ON public.taggings USING btree (role_id);


--
-- Name: index_taggings_on_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_taggings_on_slug ON public.taggings USING btree (slug);
...
CREATE INDEX index_taggings_on_tenant ON public.taggings USING btree (tenant_type, tenant_id);
...
--
-- Name: index_tags_on_creator; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tags_on_creator ON public.tags USING btree (creator_type, creator_id);


--
-- Name: index_tags_on_scope; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tags_on_scope ON public.tags USING btree (scope_type, scope_id);
...
--
-- Name: index_tags_on_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tags_on_tenant ON public.tags USING btree (tenant_type, tenant_id);
...
--
-- Name: taggings_taggable_tagger_idy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX taggings_taggable_tagger_idy ON public.taggings USING btree (taggable_id, taggable_type, tagger_id, context);


--
-- Name: taggings_tagger_idy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX taggings_tagger_idy ON public.taggings USING btree (tagger_id, tagger_type);
...
--
-- Name: items fk_rails_cbf1657e00; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.items
    ADD CONSTRAINT fk_rails_cbf1657e00 FOREIGN KEY (source_id) REFERENCES public.sources(id);
